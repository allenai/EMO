...
MODEL_GROUPS: Dict[str, str] = {
    ...
    MAIN_MODEL_GROUP_LABEL_K8: (
        f"{MAIN_MODEL}_"
        "task-{task_core}_rc_validation_keepk8_finetune-task-{task_core}_rc_train_step{step}-hf"
    ),
...
BASELINE_MODELS: Dict[str, str] = {
    "moe full": (
        "moe_1b14b_128experts_olmoe-mix_130B_1117_step30995-hf"
    ),
    MAIN_MODEL_BASELINE_LABEL: (
        f"{MAIN_MODEL}-hf"
    ),
    "dense full": (
        "dense_1b_olmoe-mix_1119_step30995-hf"
    ),
}
