...
#
    ...
    "task-socialiqa_rc_validation${postfix}/finetune-socialiqa_rc_train/step1215-hf"
    "task-socialiqa_rc_validation${postfix}/finetune-socialiqa_rc_train/step2430-hf"
    "task-socialiqa_rc_validation${postfix}/finetune-socialiqa_rc_train/step3645-hf"
    "task-socialiqa_rc_validation${postfix}/finetune-socialiqa_rc_train/step4860-hf"
    "task-socialiqa_rc_validation${postfix}/finetune-socialiqa_rc_train/step6075-hf"
