# PARENT: "moelbreducedp_sharedexp_1b14b_lr-4e-3_lb-1e-1_1T_0322_anneal.sh" (checkpoint)
#         "twolevelbatchlbreducedpsharedexp1randpool-8-128_1b14b_lr-4e-3_lb-1e-1_1T_0313_anneal.sh" (architecture)
# DESCRIPTION:
#     - Cross-architecture annealing: loads moelbreducedp_sharedexp checkpoint but trains
#       with two-level randpool routing (document-level expert pooling)
...
runname="moereducedp${lb_global_batch_size}sharedexp${num_shared_experts}_1b14b_lr-4e-3_lb-${lb}_1T_0322_anneal_twolevel_randpool-${min_document_expert_pool}-${max_document_expert_pool}_from_step238419"
