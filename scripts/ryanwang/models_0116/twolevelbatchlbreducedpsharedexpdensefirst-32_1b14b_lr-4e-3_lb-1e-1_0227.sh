...
# DESCRIPTION:
#     - Same as parent but first two layers are dense (matching active param count: top_k * moe_hidden_size = 8192)
# STATUS: NEW
##############################################################
...
runname="twolevelbatchlbreducedp${lb_global_batch_size}sharedexp${num_shared_experts}densefirst-${document_expert_pool}_1b14b_lr-${lr}_lb-${lb}_0227"
...
#  --model-type="two-level_lb-batch_reduce-dp_sharedexp_densefirst" \
