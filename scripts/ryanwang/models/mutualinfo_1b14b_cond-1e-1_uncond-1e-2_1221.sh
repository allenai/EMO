...
# DESCRIPTION:
#     - Changed cond from 1e-2 to 1e-1 since it doesn't seem to specialize as well
# STATUS: USED
##############################################################

runname="mutualinfo_1b14b_cond-1e-1_uncond-1e-2_1221"
...
python -m olmo_core.launch.beaker \
  ...
  --is_private_repo \
    ...
    $runname \
	  ...
	  --model.block.feed_forward_moe.z_loss_weight=null \
	  --model.block.feed_forward_moe.lb_loss_weight=null \
	  --expert_cond_token_entropy_bias=1e-1 \
