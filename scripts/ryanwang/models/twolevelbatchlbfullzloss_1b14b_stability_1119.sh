...
# DESCRIPTION:
#     - changed zloss calculation to also include all masked experts (i.e don't change logits to -inf for masked experts when calculating zloss)
# STATUS: DEPRICATED
#     - turns out if you add zloss to all masks the model gets unstable and performance degrades (did not even train to completion)
##############################################################
document_expert_pool=32
#document_expert_pool=12

runname="twolevelbatchlbfullzloss-${document_expert_pool}_1b14b_stability_1119"
...
#  --model-type="two-level_lb-batch_fullzloss" \
