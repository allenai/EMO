...
# DESCRIPTION:
#     - set to top-16 instead of top-32 to have a different expert pool size
# STATUS: USED
##############################################################
document_expert_pool=16

runname="twolevelbatchlb-${document_expert_pool}_1b14b_stability_1126"
