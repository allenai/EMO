# PARENT: "twolevelbatchlb-16_1b14b_stability_1126.sh
# DESCRIPTION:
#     - set to top-8 instead of top-32 to have a different expert pool size. Hypothesis is that if the total active params is too much then lb becomes really hard and training really unstable.
# STATUS: USED
##############################################################
document_expert_pool=8

runname="twolevelbatchlb-${document_expert_pool}_1b7b_stability_1207"
