...
# DESCRIPTION:
#     - Same as parent except increased the lb loss weight to 1000 to debug what happens with less experts
# STATUS: USED
##############################################################

runname="moe_1b14b_128experts_lb-1e-2_1213_replicatev2_oldscoreslogits"
