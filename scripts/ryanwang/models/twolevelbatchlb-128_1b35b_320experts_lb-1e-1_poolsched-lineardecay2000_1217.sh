# PARENT: twolevelbatchlb-32_1b35b_320experts_lb-1e-1_poolsched-lineardecay2000_1216.sh
# DESCRIPTION:
#     - changed document_expert_pool from 32 to 128 after observing deterioration occured once pool size dropped below 128.
# STATUS: USED
##############################################################
document_expert_pool=128
#document_expert_pool=6

runname="twolevelbatchlb-${document_expert_pool}_1b35b_320experts_lb-1e-1_poolsched-lineardecay2000_1217"
