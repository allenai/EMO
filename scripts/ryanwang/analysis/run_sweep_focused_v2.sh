#!/bin/bash
# Focused sweep v2: follow-up from v1 results.
#
...
#
# Usage:
#   bash scripts/ryanwang/analysis/run_sweep_focused_v2.sh <DATA_DIR>
set -e
...
DATA_DIR="$1"
OUTPUT_TSV="${DATA_DIR}/sweep_results_focused_v2.tsv"
...
echo ""
echo "================================================================"
echo "  SWEEP v2 COMPLETE: $COUNT runs"
