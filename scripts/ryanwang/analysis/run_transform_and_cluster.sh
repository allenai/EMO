...
#   bash scripts/ryanwang/analysis/run_transform_and_cluster.sh <DATA_DIR> logits mean_pca_l2 kmeans "8 16 32 64 128"
#
#   # Single run with saving:
#   bash scripts/ryanwang/analysis/run_transform_and_cluster.sh <DATA_DIR> logits mean_pca_l2 kmeans 64 --save
#
