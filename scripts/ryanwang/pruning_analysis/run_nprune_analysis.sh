...
MODEL="moereducedp512sharedexp1_1b14b_lr-4e-3_lb-1e-1_1T_0322_anneal_from_step238419/step250339-hf"
...
PYTHONUNBUFFERED=1 python -u -m src.hf_training.analyze_nprune_keep_sets \
