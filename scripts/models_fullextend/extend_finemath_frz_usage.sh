#!/usr/bin/env bash
# New-expert extension for the USAGE-ghost model: take the usage-ghost checkpoint, add one
...
VARIANT=usage source "$(dirname "${BASH_SOURCE[0]}")/extend_finemath_frz_common.sh"
