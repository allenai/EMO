#!/usr/bin/env bash
# New-expert extension for the NO-GHOST EMO baseline: take the unmodified EMO 1B/14B 130B
# checkpoint (step11921), add one instantiated expert (128->129, uniform-average init), and
