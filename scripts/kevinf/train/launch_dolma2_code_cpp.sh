#!/bin/bash
# Launch OLMo3-1B continued pretraining on dolma2-code-cpp (stack-edu C++ only)
#
# Usage: bash scripts/kevinf/train/launch_dolma2_code_cpp.sh
#
# Model: OLMo3-1B (1B parameters)
# Data: dolma2-code-cpp (stack-edu C++, ~49.1B tokens)
# Base: 130B Dolma pretrained checkpoint

# Hyperparameters (easy to change for sweeps)
dataset="dolma2-code-cpp"
warmup_fraction=0.1
