...
#
# Usage: bash scripts/kevinf/train/launch_dolma50_swallow_stackv2_python50.sh
#
# Model: OLMo3-1B (1B parameters)
# Data: 50% Python (swallow-code-v2 ~49.95B + stack-v2 ~11.54B = ~61.49B) + 50% OLMo web ~61.49B
# Base: 130B Dolma pretrained checkpoint
# Training: 10B tokens total (5B code + 5B web)

# Hyperparameters (easy to change for sweeps)
dataset="dolma50-swallow-stackv2-python50"
warmup_fraction=0.1
...
for lr in 5e-5; do
  runname="train-olmo3-1b-${dataset}-${train_tokens_B}B-lr${lr}-ctd"
