#!/bin/bash
# Launch OLMo3-1B continued pretraining on stack-v2-python-p75 (Stack-v2 Python quality_p75+)
#
# Usage: bash scripts/kevinf/train/launch_stack_v2_python_p75.sh
#
# Model: OLMo3-1B (1B parameters)
# Data: stack-v2-python-p75 (Stack-v2 Python quality_p75 through p95, ~11.54B tokens available)
...
for lr in 5e-5; do
  ...
  python -m olmo_core.launch.beaker \
    ...
    --trainer.callbacks.lm_evaluator_2.eval_dataset.mix=stack-v2-python-p75 \
