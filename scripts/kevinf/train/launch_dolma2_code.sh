#!/bin/bash
# Launch OLMo3-1B continued pretraining on dolma2-code (stack-edu code mix)
#
# Usage: bash scripts/kevinf/train/launch_dolma2_code.sh
#
# Model: OLMo3-1B (1B parameters)
# Data: dolma2-code (stack-edu: 15 programming languages, ~409B tokens)
