#!/bin/bash
# Launch OLMo3-1B continued pretraining on stack-v2-cpp-p75 (Stack-v2 C++ quality_p75+)
#
# Usage: bash scripts/kevinf/train/launch_stack_v2_cpp_p75.sh
#
# Model: OLMo3-1B (1B parameters)
# Data: stack-v2-cpp-p75 (Stack-v2 C++ quality_p75 through p95, ~14.0B tokens available)
