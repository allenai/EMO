...
#
# Usage: bash scripts/kevinf/train/launch_dolma50_swallow_python50.sh
#
# Model: OLMo3-1B (1B parameters)
# Data: 50% swallow-code-v2 Python ~49.95B + 50% OLMo web ~49.95B
# Base: 130B Dolma pretrained checkpoint
# Training: 10B tokens total (5B code + 5B web)

# Hyperparameters (easy to change for sweeps)
dataset="dolma50-swallow-python50"
warmup_fraction=0.1
