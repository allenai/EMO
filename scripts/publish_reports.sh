...
EXPERIMENTS=(
    ...
    "debug_validation|v3-small perplexity validation (11 sets) of the OLMoE3-ladder 275M 512-expert arms across training — standard router vs EMO with uniform / Beta(2,1) / Beta(4,1) document pool sizes; skewing pools large closes EMO's full-routing CE gap; plus pretraining CE loss"
