...
CHECKPOINT="${CHECKPOINT:-${WEKA_ROOT}/sparse_experts/sparse_8of512_10b/step2384}"
DOCS="${DOCS:-${WEKA_ROOT}/sparse_experts/coactivation/docs_40k/docs.jsonl.gz}"
OUT_DIR="${OUT_DIR:-${WEKA_ROOT}/sparse_experts/coactivation/sparse_8of512_10b_step2384}"
...
runname="coact_8of512_step2384${MAX_DOCS:+_pilot${MAX_DOCS}}"
