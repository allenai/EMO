...
# expert pools (olmoe3_275m_emo_randsel64_10b, pool size uniform in [64, 512]) continued jointly from its 10B checkpoint to 30B on the
...
#   bash scripts/sparse_experts/model_scripts/olmoe3_275m_randsel64_30b_baseline.sh [dry_run]
...
export OLMOE3_RUNNAME="${OLMOE3_RUNNAME:-olmoe3_275m_randsel64_30b}"
export OLMOE3_WANDB_TAGS=30b,olmoe3_squares_randsel64k4,pool_select_random,pool_min64
source "$(dirname "${BASH_SOURCE[0]}")/olmoe3_275m_10b.sh" "${1:-launch}" \
    --trainer.load_path=/weka/oe-training-default/ryanwang/EMO/debug_validation/olmoe3_275m_emo_randsel64_10b/step19074 \
