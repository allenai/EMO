...
#     1024 total experts. Everything else matches the meta_learning vanilla EMO-128e baseline:
#     pool min=8 / max=1024 / eval=1024, lb 1e-1, lr 2e-3 flat WSD trunk (decay_steps=1),
...
#         total 26.483B | active 0.914B | expert weights 1610.6M / layer
...
#   MODE=beaker bash scripts/sparse_experts/model_scripts/sparse_8of1024_10b.sh
##############################################################
