...
#     128 total experts. Everything else matches the meta_learning vanilla EMO-128e baseline:
#     pool min=8 / max=128 / eval=128, lb 1e-1, lr 2e-3 flat WSD trunk (decay_steps=1),
...
#         total 3.905B | active 0.885B | expert weights 201.3M / layer
