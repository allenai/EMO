...
# (pool size uniform in [16, 512], random experts in the pool) continued jointly from its 30B checkpoint (olmoe3_275m_randsel_30b/step57221)
...
#   bash scripts/sparse_experts/model_scripts/olmoe3_275m_randsel_130b_baseline.sh [dry_run]
...
export OLMOE3_RUNNAME="${OLMOE3_RUNNAME:-olmoe3_275m_randsel_130b}"
export OLMOE3_WANDB_TAGS=130b,olmoe3_squares_randsel4,pool_select_random
source "$(dirname "${BASH_SOURCE[0]}")/olmoe3_275m_10b.sh" "${1:-launch}" \
    --trainer.load_path=/weka/oe-training-default/ryanwang/EMO/sparse_experts/olmoe3_275m_randsel_30b/step57221 \
