...
#     512 total experts. Everything else matches the meta_learning vanilla EMO-128e baseline:
#     pool min=8 / max=512 / eval=512, lb 1e-1, lr 2e-3 flat WSD trunk (decay_steps=1),
...
#         total 13.581B | active 0.898B | expert weights 805.3M / layer
...
#   MODE=beaker bash scripts/sparse_experts/model_scripts/sparse_8of512_10b.sh
##############################################################
