...
export OLMOE3_LD_SIGNAL="${OLMOE3_LD_SIGNAL:-ste}"
export OLMOE3_LD_LAMBDA_COV="${OLMOE3_LD_LAMBDA_COV:-1.0}"
export OLMOE3_PPL_EVAL_INTERVAL=1000
export OLMOE3_FIXED_STEPS=2000
tag="T${OLMOE3_LD_TEMP}_l${OLMOE3_LD_LAMBDA}_w${OLMOE3_LD_WARMUP}_m${OLMOE3_LD_LR_MULT}${OLMOE3_LD_INIT:+_i${OLMOE3_LD_INIT}}$([[ "$OLMOE3_LD_SIGNAL" != ste ]] && echo "_${OLMOE3_LD_SIGNAL}${OLMOE3_LD_LAMBDA_COV:+c${OLMOE3_LD_LAMBDA_COV}}")${OLMOE3_LD_SUFFIX:-}"
