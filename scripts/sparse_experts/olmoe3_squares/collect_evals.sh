...
for s in (20000,25000,30000,35000,38148):
    bp=next((ppl(f"{P}/{r}/step{t}.json") for r in ("olmoe3_275m_emo_20b","olmoe3_275m_emo_20b_filler","olmoe3_275m_emo_20b_1node") for t in (s, s-1) if os.path.exists(f"{P}/{r}/step{t}.json")), None)
