...
def build_q4():
    ...
    body += card("info", "Method",
        ...
        "<li><b>Coverage</b> asks the router. Each document spreads its router probability over the experts; the pool grows while the expert at "
        "rank d still receives more than a threshold of that probability. The threshold is &lambda;<sub>d</sub> / (<b>&lambda;<sub>cov</sub></b> "
        "&middot; 496): a larger &lambda;<sub>d</sub> shrinks pools, a larger &lambda;<sub>cov</sub> grows them.</li>"
        "</ul></li>"
