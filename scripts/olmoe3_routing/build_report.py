...
def build_q4():
    ...
    body += card("info", "Method",
        ...
        "<li><b>Coverage</b> asks the router. Averaging the router's softmax over a document's tokens gives that document's share of routing "
        "for each expert (say 3% on one expert, 0.5% on another; the shares sum to 100%). Each expert added to the pool brings in its share, "
