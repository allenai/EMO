...
#
# Usage:
#   bash scripts/analysis/run_extract_embeddings_shuffled_token_truncated.sh [MODEL_PATH] [TARGET_TOKENS] [MAX_TOKENS_PER_DOC]
#
# Examples:
#   # Default: 1M tokens, 100 tokens/doc, both models
#   bash scripts/analysis/run_extract_embeddings_shuffled_token_truncated.sh
#
#   # Custom model
#   bash scripts/analysis/run_extract_embeddings_shuffled_token_truncated.sh models/moereducedp512_1b14b_lr-4e-3_lb-1e-1_0211/step30995-hf
#
