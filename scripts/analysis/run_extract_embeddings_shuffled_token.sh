...
#
# Usage:
#   bash scripts/analysis/run_extract_embeddings_shuffled_token.sh [MODEL_PATH] [TARGET_TOKENS]
#
# Examples:
#   bash scripts/analysis/run_extract_embeddings_shuffled_token.sh models/moereducedp512_1b14b_lr-4e-3_lb-1e-1_0211/step30995-hf
#   bash scripts/analysis/run_extract_embeddings_shuffled_token.sh models/moereducedp512_1b14b_lr-4e-3_lb-1e-1_0211/step30995-hf 1000000
#
