...
annealed models are compared:
    ...
    Emo       / 8              -> "specialized moe 1T + anneal (keepk 8)"
    Emo       / 16             -> "specialized moe 1T + anneal (keepk 16)"
    Emo       / 32             -> "specialized moe 1T + anneal (keepk 32)"
    Emo       / 128 (trained)  -> "specialized moe 1T + anneal (keepk 128)"
"""
