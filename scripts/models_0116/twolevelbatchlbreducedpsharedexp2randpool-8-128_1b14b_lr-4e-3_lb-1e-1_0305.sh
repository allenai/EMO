...
runname="twolevelbatchlbreducedp${lb_global_batch_size}sharedexp${num_shared_experts}randpool-${min_document_expert_pool}-${max_document_expert_pool}eval${eval_document_expert_pool}_1b14b_lr-${lr}_lb-${lb}_0305"
