...
#
#     Run scripts/meta_learning/verify_meta_step.py FIRST (the mechanism-correctness gate).
#
#   bash scripts/meta_learning/smoke_local.sh                # all modes + alpha sweep
#   MODES="same_tokens" ALPHAS="3e-2" bash scripts/meta_learning/smoke_local.sh
##############################################################
