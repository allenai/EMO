# PARENT: "scripts/meta_learning/model_scripts/meta_sametok.sh"
# DESCRIPTION:
...
#   MODE=beaker bash scripts/meta_learning/model_scripts/meta_sametok_ws.sh
...
launch src/scripts/train/olmoe-1B-7B_fsl_meta.py $runname \
		...
		--trainer.callbacks.wandb.tags="[pretraining, ${EXPERIMENT_NAME}, same_tokens_ws]" \
