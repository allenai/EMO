...
#
#   MODEL=sametok_ws_lam05 bash scripts/meta_learning/eval_scripts/launch_embed_docs.sh          # pilot: shards 0-15
#   MODEL=sametok_ws_lam05 SHARDS="$(seq -s, 0 127)" JOBS=4 bash scripts/meta_learning/eval_scripts/launch_embed_docs.sh
#   DRY_RUN=1 MODEL=... bash scripts/meta_learning/eval_scripts/launch_embed_docs.sh
#
