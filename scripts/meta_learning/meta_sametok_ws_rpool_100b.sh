...
#   MODE=beaker bash scripts/meta_learning/meta_sametok_ws_rpool_100b.sh
...
runname="meta128_sametok_ws_rpool_100b"
...
launch src/scripts/train/olmoe-1B-7B_fsl_meta.py $runname \
		...
		--trainer.callbacks.wandb.tags="[pretraining, ${EXPERIMENT_NAME}, same_tokens_ws_rpool, 100b]" \
