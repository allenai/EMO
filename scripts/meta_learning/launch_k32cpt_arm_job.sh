...
#
#   MODEL=sametok_ws_lam05 bash scripts/meta_learning/launch_k32cpt_arm_job.sh
#   MODEL=vanilla          bash scripts/meta_learning/launch_k32cpt_arm_job.sh
#
...
python -m olmo_core.launch.beaker \
    ...
    -- bash scripts/meta_learning/k32cpt_arm_worker.sh
