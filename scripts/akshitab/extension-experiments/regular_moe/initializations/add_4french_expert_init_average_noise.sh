# PARENT: NONE
# DESCRIPTION:
#     - Extension experiment (french): Add new expert initialized from AVERAGE, then train only the new expert on french dataset
# STATUS: USED
##############################################################
...
NEW_BASE_MODEL_PATH="${EXTENSIONS}/moe_1b14b_${TOTAL_EXPERTS}experts_olmoe-mix_130B_1103_step30995_init_average_noise_10perc"
...
RUN_NAME="ff-moe1b14b_${TOTAL_EXPERTS}experts_${NUM_NEW_EXPERTS}trained_croissant_init_average_noise_10pc_${NUM_BILLION_TOKENS}B_lr_${LR}"
