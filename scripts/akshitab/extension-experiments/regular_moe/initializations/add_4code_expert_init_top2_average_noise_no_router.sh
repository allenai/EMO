# PARENT: NONE
# DESCRIPTION:
#     - Extension experiment (code): Add new expert initialized from top2 average + noise, then train only the new expert on code dataset (router frozen)
# STATUS: USED
##############################################################
...
NEW_BASE_MODEL_PATH="${EXTENSIONS}/moe_1b14b_${TOTAL_EXPERTS}experts_olmoe-mix_130B_1103_step30995_init_top2_code_average_noise"
...
RUN_NAME="ff-moe1b14b_${TOTAL_EXPERTS}experts_${NUM_NEW_EXPERTS}trained_code_mix_init_top2_average_noise_no_router_${NUM_BILLION_TOKENS}B_lr_${LR}"

launch src/scripts/akshitab/add_finegrained_expert/train_new_expert_no_router.py ${RUN_NAME} \
