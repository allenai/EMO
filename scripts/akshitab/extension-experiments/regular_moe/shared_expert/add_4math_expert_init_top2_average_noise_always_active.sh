...
SHARED_EXPERTS=56 # Top global expert as per python src/scripts/eval/router_analysis.py --router-files router_evals/moe_1b14b_128experts_olmoe-mix_130B_prenorm_noqknorm_1123_step30995-hf/task-hellaswag_rc_test-router.jsonl
...
launch src/scripts/akshitab/add_finegrained_expert/train_new_expert_always_active.py ${RUN_NAME} \
