...
SHARED_EXPERT_INIT=56

# Part 1: Add new expert
BASE_MODEL_PATH="/weka/oe-training-default/akshitab/FlexMoE/models/extensions/moe_1b14b_128experts_1shared_expert_init_${SHARED_EXPERT_INIT}"
NEW_BASE_MODEL_PATH="/weka/oe-training-default/akshitab/FlexMoE/models/extensions/moe_1b14b_${TOTAL_EXPERTS}experts_1shared_expert_${SHARED_EXPERT_INIT}_init_top2_average"
...
RUN_NAME="moe1b14b_${TOTAL_EXPERTS}experts_1shared_${SHARED_EXPERT_INIT}_${NUM_NEW_EXPERTS}trained_math_init_top2_average_${NUM_BILLION_TOKENS}B_lr_${LR}"
...
python -m olmo_core.launch.beaker \
  ...
  --shared-filesystem \
	...
	-- src/scripts/akshitab/add_finegrained_expert/train_new_expert_shared.py \
    ${RUN_NAME} \
