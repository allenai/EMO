...
RUN_NAME="moe1b14b_${TOTAL_EXPERTS}experts_${EXPERTS_TO_TRAIN//,/_}_trained_math_no_router_${NUM_BILLION_TOKENS}B_lr_${LR}"
...
python -m olmo_core.launch.beaker \
  ...
  --is_private_repo \
	...
	-- src/scripts/akshitab/add_finegrained_expert/train_selected_experts_no_router.py \
    ${RUN_NAME} \
