...
# Top 4 math experts (excluding shared expert 127) from router analysis
# python src/scripts/eval/router_analysis.py --router-files router_evals/twolevelbatchlbreducedp512sharedexp1randpool-8-128eval32_1b14b_lr-4e-3_lb-1e-1_0301_step30995-hf/task-gsm8k_generation_test_0shot-router.jsonl
EXPERTS_TO_TRAIN=99,0,42,88  # TODO: update with actual top 4 non-shared experts
...
RUN_NAME="twolevel_1b14b_${TOTAL_EXPERTS}experts_${EXPERTS_TO_TRAIN//,/_}_trained_math_${NUM_BILLION_TOKENS}B_lr_${LR}"
