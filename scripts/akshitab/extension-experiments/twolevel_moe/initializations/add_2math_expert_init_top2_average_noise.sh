...
NEW_BASE_MODEL_PATH="/weka/oe-training-default/akshitab/FlexMoE/models/extensions/twolevelbatchlb-32_1b14b_${TOTAL_EXPERTS}experts_stability_prenorm_noqknorm_1121_step30995_init_top2_average_noise"
...
# 	--init_method similar \
#     --activation_file twolevel-task-gsm8k_generation_test_0shot-router.jsonl \
#     -k 2 \
...
# # Part 2: Train with new expert
RUN_NAME="freeze-fix-twolevel_${TOTAL_EXPERTS}experts_${NUM_NEW_EXPERTS}trained_math_init_top2_average_noise_${NUM_BILLION_TOKENS}B_lr_${LR}"
