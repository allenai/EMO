# PARENT: NONE
# DESCRIPTION:
#     - Extension experiment (math): Add new expert initialized from RANDOM_EXPERT, then train only the new expert on math dataset
# STATUS: USED
##############################################################
...
NEW_BASE_MODEL_PATH="/weka/oe-training-default/akshitab/FlexMoE/models/extensions/moe_1b14b_129experts_olmoe-mix_130B_1103_step30995_init_random_expert"
