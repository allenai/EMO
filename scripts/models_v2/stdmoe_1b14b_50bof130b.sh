# PARENT: "scripts/models_fullextend/stdmoe_1b14b_50bof130b.sh"
# DESCRIPTION:
#     - models_v2 home for the standard top-k MoE 1B/14B 50B-token (130B LR schedule)
#       baseline. Same recipe as the models_fullextend stdMoE baseline, repointed to the
#       models_v2 experiment (wandb tag models_v2, save root .../EMO/models_v2). The
#       trained checkpoints are symlinked into models_v2/ from models_fullextend.
