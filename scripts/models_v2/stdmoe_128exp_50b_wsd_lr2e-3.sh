# PARENT: "scripts/models_v2/stdmoe_128exp_50b_wsd.sh" (lr4e-3 twin) + "scripts/models_v2/stdmoe_64exp_50b_wsd_lr2e-3.sh"
# DESCRIPTION:
...
#       Identical to stdmoe_128exp_50b_wsd.sh EXCEPT the peak LR is 2e-3 (vs the 4e-3 default):
#         1. Peak LR is 2e-3.
...
runname="stdmoe_128exp_50b_wsd_lr2e-3"
