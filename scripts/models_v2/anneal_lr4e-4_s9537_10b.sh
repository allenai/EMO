...
# Saves hierarchically to .../stdmoe_64exp_50b_wsd_lr4e-4/anneals/s9537_10b/ .
#
#   git add . && git commit && git push origin <branch>
#   MODE=beaker bash scripts/models_v2/anneal_lr4e-4_s9537_10b.sh
export TRUNK_RUN="stdmoe_64exp_50b_wsd_lr4e-4"
export CKPT_STEP=9537    # 40B (a fixed_step permanent checkpoint in the lr4e-4 trunk)
