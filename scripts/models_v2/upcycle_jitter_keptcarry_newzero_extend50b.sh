#!/bin/bash
# Expert-upcycling ablation leaf: jitter_keptcarry_newzero -- FULL 50B EXTEND PASS.
...
#   MODE=beaker bash scripts/models_v2/upcycle_jitter_keptcarry_newzero_extend50b.sh
