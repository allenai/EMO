...
# Saves hierarchically to .../stdmoe_64exp_50b_wsd_lr2e-3/anneals/s10729_5b/ .
#
#   git add . && git commit && git push origin <branch>
#   MODE=beaker bash scripts/models_v2/anneal_lr2e-3_s10729_5b.sh
export TRUNK_RUN="stdmoe_64exp_50b_wsd_lr2e-3"
export CKPT_STEP=10729   # 45B (a fixed_step permanent checkpoint in the lr2e-3 trunk)
