...
REVISION = "2d1eb3e9f779fab1ccdb662bfd56a235a72c5b8e"
SOURCE = (
...
METHODS = (
    ...
    {
        "key": "post_e4_sequential_replay_bs256_dr_simbs64",
        "label": "Sequential replay (BS256, simBS64, BS1024 E4 init, DR)",
        "tableLabel": "Sequential replay\nBS256\nsimBS64\nBS1024 E4 init\nDR",
        "globalBatchSequences": 256,
...
def run(global_bs: int, sim_bs: int, lr: str) -> dict:
    ...
    pre_decay, endpoint = (1716, 1908) if global_bs == 1024 else (4290, 5056)
...
def main() -> None:
    ...
    report["setup"] = (
        ...
        "staleness3 at BS1024/simBS256 and BS256/simBS64, each at LR1e-3 and5e-4, "
