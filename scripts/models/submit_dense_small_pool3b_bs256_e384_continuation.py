...
def producer_spec(
    ...
    spec["description"] = (
        ...
        "gradient accumulation 2, auto-resume, eight retries, minRuntime=8h; "
...
def evaluator_spec(
    ...
    reserved = evaluator_submitter.runtime(item, epoch)
    task["context"]["minRuntime"] = str(reserved["minRuntime"])
    spec["description"] = (
        ...
        f"pre-decay checkpoint; minRuntime={reserved['minRuntime']}."
    )
    return spec
