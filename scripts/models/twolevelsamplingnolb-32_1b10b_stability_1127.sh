# PARENT: "twolevelsamplingnolb_1b14b_stability_1127.sh
# DESCRIPTION:
#     - reduced total amount of experts from 128 to 96. Check to see whether the # of experts it uses still converges to ~50 experts
# STATUS: USED
##############################################################
document_expert_pool=32
#document_expert_pool=12

runname="twolevelsamplingnolb-${document_expert_pool}_1b10b_stability_1127"
...
#  --model-type="two-level_sampling_nolb" \
...
python -m olmo_core.launch.beaker \
  ...
  --beaker-image tylerr/olmo-core-tch280cu128-2025-11-25 \
    ...
    $runname \
		...
		--model.block.feed_forward_moe.num_experts=96 \
