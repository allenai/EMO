# PARENT: N/A
# DESCRIPTION:
#     - dense model trained on olmoe-mix over 130B tokens
# STATUS: DEPRICATED
#     - replaced by dense_1b_olmoe-mix_1215.sh which has in-loop evals properly set up and uses updated dataset filtering
##############################################################

runname="dense_1b_olmoe-mix_1028"
