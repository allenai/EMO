# PARENT: "twolevelbatchlb-32_1b14b_stability_lr-6e-4_1203.sh"
# DESCRIPTION:
#     - changed lr from 6e-4 to 8e-4 to ablate to improve downstream task performance, since 6e-4 seems better
# STATUS: USED
##############################################################
document_expert_pool=32
#document_expert_pool=12

runname="twolevelbatchlb-${document_expert_pool}_1b14b_stability_lr-8e-4_1203"
