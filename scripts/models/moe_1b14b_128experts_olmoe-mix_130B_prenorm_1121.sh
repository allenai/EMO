# PARENT: "moe1b14b_128experts_olmoe-mix_130B_1117.sh"
# DESCRIPTION:
#     - Same as parent but with prenorm transformer blocks instead of reorderednorm
# STATUS: USED
##############################################################

runname="moe_1b14b_128experts_olmoe-mix_130B_prenorm_1121"
