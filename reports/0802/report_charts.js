(() => {
  ...
  const key=r=>r.series||r.scheduler||`WD ${r.wd}`; const series=[...new Set(visibleRuns.map(key))];
  ...
  const chartRuns=[...chartGroups.values()];
