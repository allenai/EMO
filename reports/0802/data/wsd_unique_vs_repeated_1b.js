window.STEP2_REPORT_DATA = {
  "updated": "2026-08-02 13:24 PDT · four paired document-loss evaluations active on the corrected implementation",
  "manifest": {
    "status": "verified",
  ...
  "codelionRuns": [],
  "evaluationRuns": [
    {"kind": "paired-document-loss", "regime": "unique", "epoch": 1, "lr": "5e-4", "status": "failed", "beaker": "01KZ210CPV406PVXRCBAEH2QZC", "job": "01KZ210CT8HY78XAVSE7MAADZF", "revision": "3bdc6751", "reason": "Configuration failure before model loading or evaluation: the one-GPU Beaker launcher did not enable torchrun, so LOCAL_RANK was unset. Exit 1; no paired-stat artifact; excluded from comparisons."},
    {"kind": "paired-document-loss", "regime": "unique", "epoch": 1, "lr": "1e-3", "status": "failed", "beaker": "01KZ211VDVGPPBPBVMH9RS44BH", "job": "01KZ211VHDDVDJF3ADHP2T38SP", "revision": "3bdc6751", "reason": "Same confirmed one-GPU LOCAL_RANK configuration failure before model loading or evaluation. Exit 1; no paired-stat artifact; excluded from comparisons."},
    ...
    {"kind": "paired-document-loss", "regime": "unique", "epoch": 1, "lr": "5e-4", "status": "failed", "beaker": "01KZ21DRZTBYY26DTNTBACESHT", "job": "01KZ21DS3GFFHCTSXWM17KHREP", "wandb": "eqxuranx", "revision": "ead4c4d4", "output": "/weka/oe-training-default/sewonm/icsl/models/dense_1b_step2_0802_paired_unique_e1_lr5e-4_retry1", "reason": "Confirmed implementation failure after the exact checkpoint loaded and the first heldout batch began: eval_batch consumed input_ids before paired-stat bookkeeping read its shape, raising KeyError. Exit 1; no paired-stat artifact; excluded from comparisons. The remaining three retry1 evaluations were intentionally not submitted pending this diagnosis."},
    {"kind": "paired-document-loss", "regime": "unique", "epoch": 1, "lr": "5e-4", "status": "active", "beaker": "01KZ21VXQX8G1PDW25SDPKK88P", "job": "01KZ21VXWAM9YCM9VAT0ANQ52S", "wandb": "egyl90as", "revision": "31dbfc14", "output": "/weka/oe-training-default/sewonm/icsl/models/dense_1b_step2_0802_paired_unique_e1_lr5e-4_retry2", "reason": "Confirmed retry after batch-mutation fix; exact checkpoint and fresh output verified in Jupiter-mounted preflight; checkpoint loaded and paired heldout evaluation is progressing past the prior failure. One H100; minRuntime 0; autoResume false; no experiment retries."},
    {"kind": "paired-document-loss", "regime": "unique", "epoch": 1, "lr": "1e-3", "status": "active", "beaker": "01KZ2268ZWWJ06NMAGVK3FY6M7", "job": "01KZ226953AA7DM79NCSMTS60R", "revision": "31dbfc14", "output": "/weka/oe-training-default/sewonm/icsl/models/dense_1b_step2_0802_paired_unique_e1_lr1e-3_retry2", "reason": "Exact checkpoint and fresh output verified in Jupiter-mounted preflight. One H100; minRuntime 0; autoResume false; no experiment retries."},
    {"kind": "paired-document-loss", "regime": "repeated", "epoch": 1, "lr": "5e-4", "status": "active", "beaker": "01KZ229G6K7Z9Q4DESMFJV1FDC", "job": "01KZ229GA3P02HD1833G7X2TVV", "revision": "31dbfc14", "output": "/weka/oe-training-default/sewonm/icsl/models/dense_1b_step2_0802_paired_repeated_e1_lr5e-4_retry2", "reason": "Exact checkpoint and fresh output verified in Jupiter-mounted preflight. One H100; minRuntime 0; autoResume false; no experiment retries."},
    {"kind": "paired-document-loss", "regime": "repeated", "epoch": 1, "lr": "1e-3", "status": "active", "beaker": "01KZ22BANKBYS60SCC0P6NJ1ZA", "job": "01KZ22BAT92PQEZP9RXXVWAM5S", "revision": "31dbfc14", "output": "/weka/oe-training-default/sewonm/icsl/models/dense_1b_step2_0802_paired_repeated_e1_lr1e-3_retry2", "reason": "Exact checkpoint and fresh output verified in Jupiter-mounted preflight. One H100; minRuntime 0; autoResume false; no experiment retries."}
  ]
};
