window.STEP2_REPORT_DATA = {
  ...
  "uniqueRuns": [
    ...
    {"epoch": 2, "lr": "1e-3", "wd": "0.033", "status": "planned", "reason": "Required main-chain LR comparison. The earlier exclusion of 1e-3 applied only to retry and pool-robustness probes. Resume the matching unique epoch-1 1e-3 pre-decay step214 when capacity and preflight permit."}
  ],
  "repeatedRuns": [
    ...
    {"epoch": 2, "lr": "1e-3", "wd": "0.033", "status": "planned", "reason": "Required main-chain LR comparison. The earlier exclusion of 1e-3 applied only to retry and pool-robustness probes. Resume the matching repeated epoch-1 1e-3 pre-decay step214 when capacity and preflight permit."}
  ],
  "oldRepeatedRuns": [],
  "codelionRuns": [],
  "evaluationRuns": [
