window.STEP2_REPORT_DATA = {
  "updated": "2026-08-02 11:42 PDT · non-padded FSL evaluator fix verified; unique 4e-4 retry queued as canary",
  "manifest": {
    "status": "verified",
  ...
  "uniqueRuns": [
    ...
    {"epoch": 1, "lr": "4e-4", "wd": "0.033", "status": "queued", "beaker": "01KZ1WGXNDFXHP7FCJ33E1G5T1", "job": "01KZ1WGXZGRZJ14S2JTQ8MY3NK", "revision": "ffaa4105", "output": "/weka/oe-training-default/sewonm/icsl/models/dense_1b_step2_0802_unique_dclm5b_wsd_e1_lr4e-4_wd0.033_warmup24_retry1", "reason": "Confirmed configuration-failure retry. Focused Linux tests passed (11/11); Jupiter preflight 01KZ1WERHRDE1W78ZBD9SZSBDF verified all sources and fresh retry output; ordinary FSL subset evaluation masks only manifest-declared EOS alignment tail; minRuntime 0; autoResume false; no experiment retries; preserve step214."}
  ],
  "repeatedRuns": [
