window.STEP2_REPORT_DATA = {
  "updated": "2026-08-02 00:59 PDT · exhaustive partition scan retry starting",
  "manifest": {
  ...
  "dataGeneration": [
    ...
    },
    {
      ...
      "revision": "0834a592",
      "status": "active",
      "reason": "Infrastructure retry using a shallow single-branch clone and the same verified-empty output paths"
    }
  ],
  "uniqueRuns": [
