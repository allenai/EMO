window.STEP2_REPORT_DATA = {
  "updated": "2026-08-02 19:06 PDT · pool B epoch-1 LR sweep active; pool C materializing; independent validation pending",
  "modelSizes": {
  ...
  "poolRobustness": {
    ...
    "training": "Pool B dense-1B repeated-data epoch1 is active at LR 5e-4 and 1e-3 while pool C materializes. Pool C will use the same sweep after materialization and preflight. All runs use WD 0.033, init seed 12536, and data-order seed 0. If independent validation later fails, cancel all B/C runs and delete their outputs.",
  ...
  "poolProbeRuns": [
    {"name": "pool B", "pool": "B", "regime": "repeated", "status": "active", "epoch": 1, "lr": "5e-4", "wd": "0.033", "initSeed": 12536, "dataSeed": 0, "beaker": "01KZ2NQAW4WY392FD7RZ47SHSQ", "job": "01KZ2NQAZNEMYAF5Y9KNZRMA68", "wandb": "opmsrj51", "revision": "0e42eded", "output": "/weka/oe-training-default/sewonm/icsl/models/dense_1b_step2_0802_repeated_dclm1b_wsd_e1_lr5e-4_wd0.033_warmup24_pool_b", "reason": "Pool-robustness probe on independently sampled pool B. Training started on eight H100s; fixed pre-decay step214 will be preserved; full DCLM validation and nine tasks; minRuntime 0; autoResume false; no experiment retries. Independent full-universe pool validation is still pending, so results will remain provisional until it passes."},
    {"name": "pool B", "pool": "B", "regime": "repeated", "status": "active", "epoch": 1, "lr": "1e-3", "wd": "0.033", "initSeed": 12536, "dataSeed": 0, "beaker": "01KZ2NRWC4NW0B8YVN6YKZFBCA", "job": "01KZ2NRWFK2DBH50NYSX8NCBD9", "wandb": "kdzqqi39", "revision": "0e42eded", "output": "/weka/oe-training-default/sewonm/icsl/models/dense_1b_step2_0802_repeated_dclm1b_wsd_e1_lr1e-3_wd0.033_warmup24_pool_b", "reason": "Pool-robustness probe on independently sampled pool B. Training started on eight H100s; fixed pre-decay step214 will be preserved; full DCLM validation and nine tasks; minRuntime 0; autoResume false; no experiment retries. Independent full-universe pool validation is still pending, so results will remain provisional until it passes."}
  ],
  "seedProbeRuns": [
  ...
  "dataGeneration": [
    ...
    },
    {
      ...
      "revision": "50f2499c",
      "status": "active",
      "reason": "Authorized faster generation route on ai2/jupiter; started 2026-08-02 18:01 PDT. Pre-submission audit found zero other active/requested sewonm Jupiter H100s. The job requests 48 CPUs, 3 H100s, and 192 GiB; realized allocation is exactly 3 H100s and 67.5 CPUs. It uses fresh _50f2499c_jupiter1 output/candidate paths and runs independent full-universe A/B/C validation before emitting manifests."
    }
  ],
  "uniqueRuns": [
