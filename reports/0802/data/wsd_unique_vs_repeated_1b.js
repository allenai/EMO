window.STEP2_REPORT_DATA = {
  "updated": "2026-08-02 19:26 PDT · pool C 5e-4 submitted; pool B 5e-4 active; independent validation pending",
  "modelSizes": {
  ...
  "poolRobustness": {
    "status": "pools B and C materialized and preflighted; both 5e-4 epoch-1 probes active or queued; independent validation pending",
    "epoch2Paused": true,
  ...
  "poolProbeRuns": [
    ...
    {"name": "pool C", "pool": "C", "regime": "repeated", "status": "queued", "epoch": 1, "lr": "5e-4", "wd": "0.033", "initSeed": 12536, "dataSeed": 0, "beaker": "01KZ2Q19FEC46P7ZPFDA75B1C1", "job": "01KZ2Q19KGGSVE08MB7B0ZEH5Q", "revision": "18394b7f", "output": "/weka/oe-training-default/sewonm/icsl/models/dense_1b_step2_0802_repeated_dclm1b_wsd_e1_lr5e-4_wd0.033_warmup24_pool_c", "reason": "Pool-robustness probe on independently sampled pool C. Submitted after manifest hash verification and Jupiter-mounted source/output preflight; eight H100s requested; fixed step214; full DCLM validation and nine tasks; minRuntime 0; autoResume false; no experiment retries. Independent full-universe pool validation remains pending."}
  ],
  "seedProbeRuns": [
