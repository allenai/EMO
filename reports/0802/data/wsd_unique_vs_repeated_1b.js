window.STEP2_REPORT_DATA = {
  "updated": "2026-08-02 16:16 PDT · repeated epoch-1 seed probes complete; small-model architecture choice pending",
  "modelSizes": {
    ...
    "153M": {"label": "Dense 153M candidate", "factory": "pending explicit current-architecture config", "totalParameters": 153104896, "nonEmbeddingParameters": 101724672, "globalBatchTokens": 1048576, "warmupSteps": 95}
  },
  "manifest": {
    "status": "verified",
  ...
  "seedProbeRuns": [
    ...
    {"name": "same-seed reproducibility", "regime": "unique", "status": "pending-submission", "epoch": 1, "lr": "5e-4", "wd": "0.033", "initSeed": 12536, "dataSeed": 0, "runSuffix": "_seedprobe_same_seed", "reason": "Exact unique corpus and original initialization/data-order seeds; measures reproducibility and residual runtime nondeterminism. Excluded from LR selection grid."},
    {"name": "alternate-seed sensitivity", "regime": "unique", "status": "pending-submission", "epoch": 1, "lr": "5e-4", "wd": "0.033", "initSeed": 12537, "dataSeed": 1, "runSuffix": "_seedprobe_alt_seed", "reason": "Exact unique corpus with alternate initialization/data-order seeds; measures seed sensitivity. Excluded from LR selection grid."}
  ],
  "smallUniqueRuns": [
  ...
  "smallSeedProbeRuns": [
    {"name": "same-seed replicate A", "regime": "unique", "status": "planned", "epoch": 1, "lr": "5e-4", "wd": "0.033", "initSeed": 12536, "dataSeed": 0, "runSuffix": "_seed0_a"},
    {"name": "same-seed replicate B", "regime": "unique", "status": "planned", "epoch": 1, "lr": "5e-4", "wd": "0.033", "initSeed": 12536, "dataSeed": 0, "runSuffix": "_seed0_b"},
    {"name": "alternate-seed replicate", "regime": "unique", "status": "planned", "epoch": 1, "lr": "5e-4", "wd": "0.033", "initSeed": 12537, "dataSeed": 1, "runSuffix": "_seed1"},
    {"name": "same-seed replicate A", "regime": "repeated", "status": "planned", "epoch": 1, "lr": "5e-4", "wd": "0.033", "initSeed": 12536, "dataSeed": 0, "runSuffix": "_seed0_a"},
    {"name": "same-seed replicate B", "regime": "repeated", "status": "planned", "epoch": 1, "lr": "5e-4", "wd": "0.033", "initSeed": 12536, "dataSeed": 0, "runSuffix": "_seed0_b"},
    {"name": "alternate-seed replicate", "regime": "repeated", "status": "planned", "epoch": 1, "lr": "5e-4", "wd": "0.033", "initSeed": 12537, "dataSeed": 1, "runSuffix": "_seed1"}
  ],
  "smallEvaluationRuns": [],
  "dataGeneration": [
    {
