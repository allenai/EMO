...
class MoETwoLevelBatchLBReduceDPRouter(MoETwoLevelRouter):
    """
            ...
            with torch.autocast(enabled=False, device_type=x.device.type):
                ...
                if self.lb_loss_weight is not None:
                    ...
                    self._reducedp_unique_experts_sum += (
                        (dp_global_tot_batch_size_per_expert > 0).sum().item()
                    )
...
@dataclass
class MoETwoLevelBatchLBReduceDPRouterConfig(MoETwoLevelRouterConfig):
    ...
    def build(
        ...
        *,
        ...
        init_device: str = "cpu",
    ) -> MoETwoLevelBatchLBReduceDPRouter:
        """
        ...
        return MoETwoLevelBatchLBReduceDPRouter(**kwargs)
