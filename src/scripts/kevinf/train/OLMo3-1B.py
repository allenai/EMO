...
from olmo_core.internal.experiment import CommonComponents, DataComponents, build_config, main
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    return (
        TrainerConfig(
            save_folder=f"/weka/oe-training-default/kevinf/checkpoints/{common.run_name}/",
            save_overwrite=True,
        ...
        .with_recommended_evals(common.tokenizer, SEQUENCE_LENGTH, cluster, task_set="fast", eval_interval=3000)
    )
