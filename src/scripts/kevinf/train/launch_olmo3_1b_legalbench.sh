...
runname="test-legalbench-in-loop"
...
python -m olmo_core.launch.beaker \
  ...
  -- src/scripts/kevinf/train/OLMo3-1B-legalbench.py \
  $runname \
  ...
  --trainer.max_duration='{value: 100_000_000, unit: tokens}' \
  --trainer.hard_stop='{value: 100_000_000, unit: tokens}' \
  --trainer.callbacks.downstream_evaluator.eval_interval=2 \
