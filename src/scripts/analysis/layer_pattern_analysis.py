...
def main():
    ...
    assert D == num_layers * num_experts, \
    ...
    results = []
    print(f"{'Layer':>5} | {'Unique':>7} | {'Entropy':>8} | {'Active/doc':>10} | {'Top-10 cover':>12} | {'Top-50 cover':>12}")
    print("-" * 75)

    for l in range(num_layers):
        layer_data = reshaped[:, l, :]
        ...
        print(f"  {l:>3} | {n_unique:>7} | {entropy:>7.2f}b | "
