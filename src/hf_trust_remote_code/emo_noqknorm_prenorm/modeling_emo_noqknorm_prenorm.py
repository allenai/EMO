#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/emo_noqknorm_prenorm/modular_emo_noqknorm_prenorm.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_emo_noqknorm_prenorm.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# coding=utf-8
...
from .configuration_emo_noqknorm_prenorm import EmoNoQKNormPrenormConfig


@use_kernel_forward_from_hub("RMSNorm")
class EmoNoQKNormPrenormRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-6):
        """
        EmoNoQKNormPrenormRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class EmoNoQKNormPrenormMLP(nn.Module):
...
class EmoNoQKNormPrenormAttention(nn.Module):
    """Multi-headed attention from 'Attention Is All You Need' paper"""

    def __init__(self, config: EmoNoQKNormPrenormConfig, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
...
class EmoNoQKNormPrenormSparseMoeBlock(nn.Module):
    def __init__(
        self,
        config,
        num_experts: int,
        ...
        self.experts = nn.ModuleList(
            [EmoNoQKNormPrenormMLP(expert_config) for _ in range(self.num_experts)]
        )
...
class EmoNoQKNormPrenormDecoderLayer(GradientCheckpointingLayer):
    def __init__(
        self,
        ...
        if num_experts == 0:
            ...
            self.mlp = EmoNoQKNormPrenormMLP(dense_config)
        else:
            self.mlp = EmoNoQKNormPrenormSparseMoeBlock(
...
@auto_docstring
class EmoNoQKNormPrenormPreTrainedModel(PreTrainedModel):
    config: EmoNoQKNormPrenormConfig
    base_model_prefix = "model"
    supports_gradient_checkpointing = True
    _no_split_modules = ["EmoNoQKNormPrenormDecoderLayer"]
    ...
    _can_record_outputs = {
        "router_logits": OutputRecorder(EmoNoQKNormPrenormSparseMoeBlock, index=1),
        "hidden_states": EmoNoQKNormPrenormDecoderLayer,
        "attentions": EmoNoQKNormPrenormAttention,
    }
    config_class = EmoNoQKNormPrenormConfig


class EmoNoQKNormPrenormRotaryEmbedding(nn.Module):
    inv_freq: torch.Tensor  # fix linting for `register_buffer`

    def __init__(self, config: EmoNoQKNormPrenormConfig, device=None):
        super().__init__()
...
@auto_docstring
class EmoNoQKNormPrenormModel(EmoNoQKNormPrenormPreTrainedModel):
    def __init__(self, config):
...
class EmoNoQKNormPrenormForCausalLM(EmoNoQKNormPrenormPreTrainedModel, GenerationMixin):
    _tied_weights_keys = ["lm_head.weight"]

    def __init__(self, config):
        super().__init__(config)
        self.model = EmoNoQKNormPrenormModel(config)
        self.vocab_size = config.vocab_size
