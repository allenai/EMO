...
|---------------------------------------|---------------------------------|------------------------------|
| `EmoForCausalLM`  | `emo/`   | All MoE checkpoints          |
...
|---------------------------------------------------------------------------------------------------------------|---------------------------------------|
| `twolevelbatchlbreducedp512sharedexp1randpool-8-128eval32_1b14b_lr-4e-3_lb-1e-1_1T_0313_anneal_from_step238419/step250339-hf` | `EmoForCausalLM` |
| `twolevelbatchlbreducedp512sharedexp1randpool-8-128eval32_1b14b_lr-4e-3_lb-1e-1_0301/step30995-hf`            | `EmoForCausalLM` |
| `dense_1b_lr-4e-3_0213/step30995-hf`                                                                          | `Olmo2NoQKNormPrenormForCausalLM`    |
| `moereducedp512sharedexp1_1b4b_lr-4e-3_lb-1e-1_0308/step30995-hf`                                             | `EmoForCausalLM` |
| `moereducedp512sharedexp1_1b14b_lr-4e-3_lb-1e-1_0308/step30995-hf`                                            | `EmoForCausalLM` |
| `moereducedp512sharedexp1_1b14b_lr-4e-3_lb-1e-1_1T_0322_anneal_from_step238419/step250339-hf`                 | `EmoForCausalLM` |
| `moereducedp512sharedexp1_1b14b_lr-4e-3_lb-1e-1_1T_0322_anneal_twolevel_randpool-8-128_from_step238419/step250339-hf` | `EmoForCausalLM` |
