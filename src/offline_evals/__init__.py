...
new_task_registry: Dict = {
    ...
    **sciriff.create_bio_sciriff_qa_tasks(),
    ...
    "arc_easy:rc_train_0shot": splits_arc.ARCEasy_RC_Train_0shot,
    "arc_easy:rc_validation_0shot": splits_arc.ARCEasy_RC_Validation_0shot,
    ...
    "arc_challenge:rc_train_0shot": splits_arc.ARCChallenge_RC_Train_0shot,
    "arc_challenge:rc_validation_0shot": splits_arc.ARCChallenge_RC_Validation_0shot,
    ...
    "boolq:rc_train_0shot": splits_boolq.BoolQ_RC_Train_0shot,
    "boolq:rc_validation_0shot": splits_boolq.BoolQ_RC_Validation_0shot,
    ...
    "csqa:rc_train_0shot": splits_csqa.CommonsenseQA_RC_Train_0shot,
    "csqa:rc_validation_0shot": splits_csqa.CommonsenseQA_RC_Validation_0shot,
    ...
    "hellaswag:rc_train_0shot": splits_hellaswag.HellaSwag_RC_Train_0shot,
    "hellaswag:rc_validation_0shot": splits_hellaswag.HellaSwag_RC_Validation_0shot,
    ...
    "openbookqa:rc_train_0shot": splits_openbookqa.OpenBookQA_RC_Train_0shot,
    "openbookqa:rc_validation_0shot": splits_openbookqa.OpenBookQA_RC_Validation_0shot,
    ...
    "piqa:rc_train_0shot": splits_piqa.PIQA_RC_Train_0shot,
    "piqa:rc_validation_0shot": splits_piqa.PIQA_RC_Validation_0shot,
    ...
    "socialiqa:rc_train_0shot": splits_siqa.SocialIQA_RC_Train_0shot,
    "socialiqa:rc_validation_0shot": splits_siqa.SocialIQA_RC_Validation_0shot,
