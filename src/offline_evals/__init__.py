...
new_task_registry: Dict = {
    ...
    **sciriff.create_bio_sciriff_qa_tasks(),
    ...
    "siqa:mc_train": splits_siqa.SocialIQA_MC_Train,
    "siqa:mc_validation": splits_siqa.SocialIQA_MC_Validation,
    "siqa:mc_test": splits_siqa.SocialIQA_MC_Test,
    "siqa:rc_train": splits_siqa.SocialIQA_RC_Train,
    "siqa:rc_validation": splits_siqa.SocialIQA_RC_Validation,
    "siqa:rc_test": splits_siqa.SocialIQA_RC_Test,
